...
public class PublisherDaoJdbcTemplateImpl implements PublisherDao {
    ...
    public Publisher getPublisherById(int id) {
        ...
        try {
            return jdbcTemplate.queryForObject(SELECT_PUBLISHER_SQL, this::mapToRowPublisher, id);
    ...
    public List<Publisher> getAllPublishers() {
        ...
        return jdbcTemplate.query(SELECT_ALL_PUBLISHERS_SQL, this::mapToRowPublisher);
    }
