...
public class BookDaoJdbcTemplateImpl implements BookDao{
    ...
    public Book getBookById(int id) {
        ...
        try {
            return jdbcTemplate.queryForObject(SELECT_BOOK_SQL, this::mapToRowBook, id);
    ...
    public List<Book> getAllBooks() {
        ...
        return jdbcTemplate.query(SELECT_ALL_BOOKS_SQL, this::mapToRowBook);
    }
    ...
    public List<Book> findBooksByAuthor(int authorId) {
        return jdbcTemplate.query(Find_Books_By_Author, this::mapToRowBook);
    }
